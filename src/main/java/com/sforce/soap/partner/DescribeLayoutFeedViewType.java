...
public class DescribeLayoutFeedViewType {

    protected List<DescribeLayoutFeedFilterType> feedFilters;
     ...
     * {@link DescribeLayoutFeedFilterType }
     * 
     * 
     */
    public List<DescribeLayoutFeedFilterType> getFeedFilters() {
        if (feedFilters == null) {
            feedFilters = new ArrayList<DescribeLayoutFeedFilterType>();
        }
